...
import EditableCaseHeader from '../../../components/casedetails/EditableCaseHeader.tsx';
...
const CaseDetailsScreen = ({ navigation, route }: any) => {
  const {caseData, loading, error, isEditing, editedTitle, setEditedTitle, editedDescription, setEditedDescription, handleEdit, handleSave, handleDelete, formatDate} = useCaseDetails(route?.params?.caseId, navigation);
