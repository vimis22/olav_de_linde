...
const AcuteEmployee = ({navigation}: any) => {
  ...
  return(
        <View style={styles.moduleContent}>
          <View>
            <NormalText text={'Hvem har du brug for?'} fontSize={20} fontWeight={'bold'} />
            <NormalText text={'Vælg den service, der kan hjælpe med den akutte situation.'} fontSize={18} />
          </View>
          <View>
          ...
          <ActionButton onPress={() => navigation.navigate('LoginScreen')} title={'Ring Op'} backgroundColor={'#F9F9F4'} borderColor={'#CB4F00'} textColor={'#CB4F00'} height={50} width={100} />
        </View>
    );
};
