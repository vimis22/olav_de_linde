...
const TextFieldArea: React.FC<TextFieldAreaProps> = ({value, onChangeText, placeholder = 'TEXT', containerHeight = 60, containerWidth = 300, containerRadius = 30, backgroundColor = '#ffffff', textColor = '#000000'}) => {
  return (
