...
export const updateEmployee = async (employeeInfo: UserInfo) => {
    try {
...
export const updateAddressForEmployee = async (employeeInfo: UserInfo) => {
    try {
...
export const updateAddressForEmployeeByEmail = async (employeeInfo: UserInfo) => {
    try {
        const snapShot = await firestore()
            .collection('Employee')
...
export const updatePhoneNumberForEmployee = async (employeeInfo: UserInfo) => {
    try {
        const docRef = firestore().collection('Employee').doc(employeeInfo.id);
        const doc = await docRef.get();
...
export const updatePhoneNumberForEmployeeByEmail = async (employeeInfo: UserInfo) => {
    try {
        const snapShot = await firestore()
            .collection('Employee')
            .where('Email','==',employeeInfo.email)
